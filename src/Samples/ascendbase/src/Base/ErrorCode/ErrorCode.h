...
enum {
    ...
    APP_ERR_DVPP_PICDESC_FAIL = APP_ERR_DVPP_BASE + 12,       // DVPP: fail to create acldvppCreatePicDesc or fail to set acldvppCreatePicDesc
    APP_ERR_DVPP_CONFIG_FAIL = APP_ERR_DVPP_BASE + 13,        // DVPP: fail to set dvpp configuration,such as resize configuration,crop configuration
